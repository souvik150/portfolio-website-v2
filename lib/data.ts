...
export const profile = {
  ...
  summary:
    "Analyst at Zanskar Tech, where I lead development of Sentinel OMS, the firm's order management system. My work spans the full order lifecycle: state-machine-driven order flows, parent-child workflows, execution algorithms, real-time risk (RMS) validation, and mark-to-market accounting for low-latency trading. SEBI NISM-certified in Equity, Common, and Commodity Derivatives.",
...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Lead developer of the RMS (Risk Management System) module that enforced bans, restrictions, and MTM checks for robust risk controls.",
