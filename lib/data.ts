...
export const experience: Experience[] = [
  {
    ...
    points: [
      ...
      "Designed a dual request-ID / response-ID replay protocol between OMS and COLO — on restart each side independently replays from its last-seen ID, guaranteeing exactly-once delivery and zero missed responses without a distributed lock.",
...
export const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      "Exactly-once replay protocol without distributed locks",
    ],
